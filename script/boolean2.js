...
// 사용자가 생일 1월이라면 1월에 대한 탄생화와 꽃말이 result 출력
...
btn.addEventListener('click',()=>{
    if(month.value > 0 && month.value < 13){
        ...
        let m = month.value //month 를 간단하게 만든거
        birth_result.innerHTML =`${birthday_flower[m-1].month}월의 탄생화는 ${birthday_flower[m-1].flower}, 꽃말은 ${birthday_flower[m-1].content}
        입니다.`
    }else{
